...
class RsControllerTest {
    ...
    void should_add_rs_event() throws Exception {
        ...
        mockMvc.perform(get("/rs/event"))
                ...
                .andExpect(jsonPath("$[3].event", is("添加一条热搜")))
                .andExpect(jsonPath("$[3].keywords", is("娱乐")))
                .andExpect(jsonPath("$[3].user.user_name", is("xiaowang")))
                .andExpect(jsonPath("$[3].user.user_age", is(19)))
                .andExpect(jsonPath("$[3].user.user_gender", is("female")))
                .andExpect(jsonPath("$[3].user.user_email", is("a@thoughtworks.com")))
                .andExpect(jsonPath("$[3].user.user_phone", is("18888888888")));
